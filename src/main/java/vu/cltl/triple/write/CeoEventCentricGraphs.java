...
public class CeoEventCentricGraphs {
    ...
    static String testparameter = "--ont-file /Users/piek/Desktop/Deloitte/CLTL_CEO_version_1_sameas.owl" +
     ...
     static public void main (String[] args) {
         ...
         for (int i = 0; i < args.length; i++) {
             ...
             else if (arg.equals("--ceo-graph") && args.length>(i+1)) {
                 pathToCeoEckgFiles = args[i+1];
             }
         }
         File trigFolder = new File (pathToTrigFiles);
         File ceoFolder = new File (pathToTrigFiles);
